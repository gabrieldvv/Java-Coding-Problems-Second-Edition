...
public class P215_ContextSwitching1 {

    private static final Logger logger = Logger.getLogger(P215_ContextSwitching1.class.getName());
    ...
    public static void doSomething(int index) {
        logger.info(() -> index + " " + Thread.currentThread());
